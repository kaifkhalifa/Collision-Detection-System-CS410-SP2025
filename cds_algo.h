...
const int THINFILM_SENSOR_THRESHOLD_MID = 1500;  // Moderate severity threshold for the thin-film sensor
const int THINFILM_SENSOR_THRESHOLD_LOW = 500;  // Low severity threshold for the thin-film sensor
